...
[ext_force, ext_moment] = get_wind_signal(qd, t, qn, F, M);
%**************************************************************************

% ADRC
[F_est, M_est, state_est, disturbance] = ADRC(s, qd, t, qn, params, F, M);


% compute derivative
sdot = quadEOM_readonly(t, s, F_est, M_est, params, ext_force, ext_moment);
