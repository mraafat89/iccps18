...
%MR end
    ...
    o.action = direction;
    o.state = (floor(pos(2)) * 5) +floor(pos(1))+1; % cell position represents a state. Range is 1-25 counting row by row.
    goals_normalized_posterior = update_goals_posterior(o);
