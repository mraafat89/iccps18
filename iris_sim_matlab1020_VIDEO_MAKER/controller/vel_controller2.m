...
% Position controller
ax_des = acc_des(1) + params.kp_xy * 0 + params.kd_xy * (vel_des(1) - xdot); % + params.ki_xy*(x_int);
ay_des = acc_des(2) + params.kp_xy * 0 + params.kd_xy * (vel_des(2) - ydot); %+ params.ki_xy*(y_int);
az_des = acc_des(3) + params.kp_z  * 0 + params.kd_z  * (vel_des(3) - zdot); % + params.ki_z*(z_int);
