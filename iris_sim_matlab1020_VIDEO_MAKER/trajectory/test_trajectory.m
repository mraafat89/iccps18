...
% change line 59 the visualization goals and bad areas
...
h_3d = gca;
set(h_fig, 'Position',[100, 100, 700, 700]);
% grid on;
drawnow;
%*************************************************************************
% plot environment
...
h_legend = legend('actual trajectory','desired trajectory');
...
ye=[1 1 boundary_y-1 boundary_y-1 1];
...
yg=[boundary_y-5 boundary_y-5 boundary_y-1 boundary_y-1 boundary_y-5];
...
yb=[1 1 boundary_y-5 boundary_y-5 1];
fill(xb,yb,[0.9, 0.5, 0.5])
hold on
% xo=[boundary_x-9 boundary_x-3 boundary_x-3 boundary_x-9 boundary_x-9];
% yo=[boundary_y-5 boundary_y-5 boundary_y-4 boundary_y-4 boundary_y-5];
% fill(xo,yo,[0.8, 0.8, 0.8])
% hold on
% xo1=[boundary_x-4 boundary_x-2 boundary_x-2 boundary_x-4 boundary_x-4];
% yo1=[boundary_y-4 boundary_y-4 boundary_y-3 boundary_y-3 boundary_y-4];
% fill(xo1,yo1,[0.8, 0.8, 0.8])
% hold on
% xo2=[boundary_x-3 boundary_x-1 boundary_x-1 boundary_x-3 boundary_x-3];
% yo2=[boundary_y-3 boundary_y-3 boundary_y-2 boundary_y-2 boundary_y-3];
% fill(xo2,yo2,[0.8, 0.8, 0.8])
% hold on
...
%             QP{qn} = QuadPlot(qn, x0{qn}, 0.1, 0.04, quadcolors(qn,:), max_iter, h_3d);
            ...
            h_title = title(sprintf('iteration: %d, time: %4.2f  ( Press "q" to stop )', iter, sim_time), 'FontSize', 12);
        end
        % Run simulation
