...
if (t < 5.05 && t > 4.95 || t < 10.05 && t > 9.95 || t < 15.05 && t > 14.95 || t < 20.05 && t > 19.95 || t < 25.05 && t > 24.95 || t < 30.05 && t > 29.95)
%         [a, p1, p2] = getP(5,5,19,14); %%%%%%%%%%%%%%%%%
%          div=length(p1)/5;             %%%%%%%%%%%%%%%%%   
    if t < 20.05 && t > 19.95
        [a, p1, p2] = getP(5,5,14,9); %19,4 with starting 3,1    
        div=length(p2)/5;
    elseif t < 25.05 && t > 24.95
        [a, p1, p2] = getP(5,5,19,14); %19,4 with starting 3,1    
        div=length(p2)/5;
    else
        [a, p1, p2] = getP(5,5,19,14);
         div=length(p1)/5;    
